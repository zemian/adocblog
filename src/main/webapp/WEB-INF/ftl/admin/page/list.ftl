        ...
        <table class="bordered-table">
            ...
            <#list docs.list as doc>
                ...
                <tr>
                    ...
                    <td colspan="2">${doc.path}</td>
                    <td colspan="2">${doc.latestContent.title}</td>
                    <td rowspan="2">
                        <a href="${app.contextPath}/admin/page/preview/${doc.docId}/${doc.latestContent.contentId}" target="_blank"><span title="Detail" class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span> Preview</a>
