...
<div class="container">
    <div class="app-content">
        ...
        <p>Are you sure you want to publish Page ID ${doc.docId} with ContentID ${contentId}?</p>

        <form id="blog" class="form-horizontal" method="post" action="${app.contextPath}/admin/page/publish">
